...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a  href="{{route('demo') }}" class="logo d-flex align-items-center">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <!-- Sales Card -->
            <div class="col-xxl-24 col-md-24">
                ...
                <div class="card-body">
                  ...
                  <h2>Laravel Product List</h2>
                    <a class="btn btn-danger" href="{{route('export') }}" >export</a>
                        <a class="btn btn-success"  href="{{route('import') }}"  >import</a>
                        <a class="btn btn-success" href="{{route('create.product') }}">Create new Products </a>
                        <a class="btn btn-success" href="{{route('test') }}"> User Details </a>
                        <a class="btn btn-success" href="{{route('onethrough') }}"> One Through </a>
                        <a class="btn btn-success" href="{{route('manytomany') }}"> many to may </a>
                        <a class="btn btn-success" href="{{route('hastomanyth') }}">hastomanythrough </a>
                        <!-- <a class="btn btn-success" href="{{route('create.product') }}">Create new Products </a> -->
        ...
        <div class="modal fade mt-5" id="editProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                        ...
                        <form action="{{route('product.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Brand:</strong>
                                        <textarea class="form-control" name="brand" id="brand" style="height: 150px;" placeholder="Brand">Brand</textarea>
                    ...
                    <a class="btn btn-btn-secondary" href="{{route('demo') }}">Back Button </a>
